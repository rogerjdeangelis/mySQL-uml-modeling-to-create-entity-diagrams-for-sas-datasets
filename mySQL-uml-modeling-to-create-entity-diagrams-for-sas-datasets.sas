...
If you use formats the typing in mySQL is close to SAS formating                                                                  
  ...
  What you need to do                                                                                                             
      ...
      6. Open MySql workbench                                                                                                     
         ...
         Delete city and coountry.                                                                                                
                                                                                                                                  
         Click on text icon (lloks like a letter in the left toolbar) release button                                              
         Move to where you want the text boxk and clicke once. You                                                                
         should see a small beige box, Double clic on the box and                                                                 
         enter your "My Little Schema"                                                                                            
                                                                                                                                  
         Very intuitive from here.                                                                                                
                                                                                                                                  
         Right click on the lb table and select edit lb                                                                           
         Click of Patient and date and set non null primary key                                                                   
                                                                                                                                  
         Right click on the dm table and select edit dm                                                                           
         Click of Patient  set non null primary key                                                                               
                                                                                                                                  
         To set up the one to many relationship from lb                                                                           
         to dm First click on the 'many' table 'lb' then                                                                          
         click on the dm table                                                                                                    
                                                                                                                                  
         If you have defines your keys correctly then                                                                             
         one to many crawfoot will appear.                                                                                        
